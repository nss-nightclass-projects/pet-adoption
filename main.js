...
const pets = [
  {
    ...
    type: "cat",
    imageUrl:
      "http://kittentoarr.com/wp-content/uploads/2015/06/funny-cat-with-a-towel.jpg",
  },
  {
    name: "Trouble",
    color: "Poop-Colored",
...
const handleButtonClick = (e) => {
  ...
  if (buttonId === "All") {
    document.querySelector("#All").style.backgroundColor = "YELLOW";
  }
  if (buttonId === "cat") {
    document.querySelector("#cat").style.backgroundColor = "RED";
  }
  if (buttonId === "dog") {
    document.querySelector("#dog").style.backgroundColor = "GREEN";
  }
  if (buttonId === "dino") {
    document.querySelector("#dino").style.backgroundColor = "ORANGE";
  }
  const selectedPets = [];

...
let domString = '';
taco.forEach((item, i) => {
  domString += `<div class="card mb-md-2" style="width: 18rem;" id=${i}>
                  <h5 class="card-title alert-info card-header text-center">${item.name}</h5>
                  <img src="${item.imageUrl}" class="card-img-top p-2" alt="${item.name}">
                    ...
                    <button type="button" class="btn bg-light btn-outline-secondary" id="${i}">Delete</button>
                  </div>`
})  
